...
-- Date        : Mon Mar 06 15:14:54 2023
-- Host        : ELIA-LAPTOP running 64-bit major release  (build 9200)
-- Command     : write_vhdl -mode funcsim -nolib -force -file
--               C:/Elia/Documenti/Codici/progetto_RL/progetto_RL.sim/sim_1/synth/func/project_tb_func_synth.vhd
...
architecture STRUCTURE of ff_d is
  ...
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[0]_inst_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[10]_inst_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[11]_inst_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[12]_inst_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[13]_inst_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[14]_inst_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[15]_inst_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[1]_inst_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[2]_inst_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[3]_inst_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[4]_inst_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[5]_inst_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[6]_inst_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[7]_inst_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[8]_inst_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \o_mem_addr_OBUF[9]_inst_i_1\ : label is "soft_lutpair4";
begin
...
architecture STRUCTURE of ff_sr_8 is
  ...
  signal \^outq_reg_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \outQ[7]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \outQ[7]_i_2__0\ : label is "soft_lutpair24";
begin
  outQ_reg_0 <= \^outq_reg_0\;
...
architecture STRUCTURE of logic_block_b is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \outQ[7]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \outQ[7]_i_2__0\ : label is "soft_lutpair25";
begin
\outQ[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"20"
